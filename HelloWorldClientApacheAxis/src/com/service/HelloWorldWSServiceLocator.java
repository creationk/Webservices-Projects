...
public class HelloWorldWSServiceLocator extends org.apache.axis.client.Service implements com.service.HelloWorldWSService {
    ...
    private java.lang.String HelloWorldWSPort_address = "http://desktop-vt58dcq:8080/HelloWorldWS/HelloWorldWSService";
    ...
    public com.service.HelloWorldWS getHelloWorldWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.HelloWorldWSPortBindingStub _stub = new com.service.HelloWorldWSPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.HelloWorldWS.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.HelloWorldWSPortBindingStub _stub = new com.service.HelloWorldWSPortBindingStub(new java.net.URL(HelloWorldWSPort_address), this);
                _stub.setPortName(getHelloWorldWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.com/", "HelloWorldWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.com/", "HelloWorldWSPort"));
        }
